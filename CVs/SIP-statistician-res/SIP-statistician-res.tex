...
\AddToShipoutPictureBG*{
    \AtPageLowerLeft{
        \hspace{-0.25cm}
        \color{black}
        \rule[23.55cm]{\paperwidth}{8cm}
    }
}

% Move title up, remove whitespace below, increase icon size, try and get all subpoints on same page
\begin{document}
...
% Consider adding technical skills to 'spoonfeed' (to use Chaten's term) the qualifications
